...
public abstract class VirtuosoTestBase {

    [SkippableFact]
    public void StorageVirtuosoLoadGraph()
    {
        VirtuosoConnectorBase manager = VirtuosoTest.GetConnection();
        try
        {
    ...
    {
        VirtuosoConnectorBase virtuoso = VirtuosoTest.GetConnection();
        try
        {
