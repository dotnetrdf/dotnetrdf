...
namespace alexandria_tests
{
    ...
    public class GraphRegistryTests
    {
        ...
        [TestMethod]
        public void MongoTCGraphRegistryEnumerate()
        {
            //Load in our Test Graph
            Graph g = new Graph();
            FileLoader.Load(g, "InferenceTest.ttl");
            ...
            //Open an Alexandria Store and save the Graph
            AlexandriaMongoDBManager manager = new AlexandriaMongoDBManager(TestTools.GetNextStoreID(), MongoDBSchemas.TripleCentric);
            manager.SaveGraph(g);
        ...
        [TestMethod]
        public void MongoTCGraphRegistryEnumerateWithDefaultGraph()
        {
            //Load in our Test Graph
            Graph g = new Graph();
            FileLoader.Load(g, "InferenceTest.ttl");
            ...
            Console.WriteLine();
            Console.WriteLine("Graph URIs via ListGraphs");
        ...
        [TestMethod]
        public void MongoTCGraphRegistryEnumerateWithDefaultGraphOnly()
        {
            //Load in our Test Graph
            Graph g = new Graph();
            FileLoader.Load(g, "InferenceTest.ttl");
        ...
        [TestMethod]
        public void MongoTCGraphRegistryLookup()
        {
            //Load in our Test Graph
            Graph g = new Graph();
            FileLoader.Load(g, "InferenceTest.ttl");
        ...
        [TestMethod]
        public void MongoTCGraphRegisterUnregister()
        {
            //Load in our Test Graph
            Graph g = new Graph();
            FileLoader.Load(g, "InferenceTest.ttl");
