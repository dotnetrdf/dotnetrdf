...
public class AsyncIntegerEnumeration : IAsyncEvaluation
{
    ...
    public async IAsyncEnumerable<ISet> Evaluate(PullEvaluationContext context, ISet? input, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
