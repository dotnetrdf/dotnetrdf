...
sed -i "s/^\(NumberOfBuffers\s*= \)[0-9]*/\1$nBuffers/" /virtuoso-opensource/database/virtuoso.ini
sed -i "s/^\(MaxDirtyBuffers\s*= \)[0-9]*/\1$dirtyBuffers/" /virtuoso-opensource/database/virtuoso.ini
