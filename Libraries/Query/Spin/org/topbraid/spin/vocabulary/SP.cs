...
namespace org.topbraid.spin.vocabulary
{
	...
	private static void init(Personality<INode> p) {
    	...
    	p.Add(org.topbraid.spin.model.update.Delete, new SimpleImplementation(Delete, org.topbraid.spin.model.update.impl.DeleteImpl));
    	...
    	p.Add(org.topbraid.spin.model.update.Insert, new SimpleImplementation(Insert, org.topbraid.spin.model.update.impl.InsertImpl));
