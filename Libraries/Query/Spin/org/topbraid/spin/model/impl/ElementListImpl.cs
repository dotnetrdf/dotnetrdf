...
namespace org.topbraid.spin.model.impl
{
    ...
    public class ElementListImpl : ElementImpl, IElementList
    {
        ...
        private int printTriplePattern(List<IElement> elements, int i, IContextualSparqlPrinter p)
        {
        ...
        private void printRDFList(IContextualSparqlPrinter p, List<IResource> members)
        {
            p.print("(");
