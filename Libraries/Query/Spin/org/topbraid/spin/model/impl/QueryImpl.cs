...
namespace org.topbraid.spin.model.impl
{
    ...
    public abstract class QueryImpl : AbstractSPINResource, ISolutionModifierQuery
    {
        ...
        protected void printStringFrom(IContextualSparqlPrinter context)
        {
        ...
        protected void printSolutionModifiers(IContextualSparqlPrinter context)
        {
        ...
        private void printOrderByExpression(IContextualSparqlPrinter sb, IResource node)
        {
            ...
            if (node is INode)
            {
                ...
                {
                    sb.print("(");
                    IContextualSparqlPrinter pc = sb.clone();
                    pc.setNested(true);
                    call.print(pc);
                    sb.print(")");
                    return;
        ...
        protected void printValues(IContextualSparqlPrinter p)
        {
