...
namespace VDS.RDF.Query.Spin.Model
{
    ...
    public class ResourceFactory
    {
        ...
        public static IResource asExpression(IResource resource)
        {
            ...
            {
                IVariableResource var = ResourceFactory.asVariable(resource);
                if (var != null)
                {
                    return var;
                }
                IAggregationResource aggr = ResourceFactory.asAggregation((IResource)resource);
                if (aggr != null)
                {
                    return aggr;
                }
                IFunctionCallResource functionCall = ResourceFactory.asFunctionCall((IResource)resource);
