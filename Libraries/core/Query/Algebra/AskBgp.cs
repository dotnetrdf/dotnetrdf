...
namespace VDS.RDF.Query.Algebra
{
    ...
    /// <remarks>
    /// <para>
    /// <strong>Note: </strong> This is experimental code currently designed only for optimisation of ASK queries and not yet fully integrated into the library
    /// </para>
    /// <para>
    ...
    /// </para>
    /// </remarks>
    public class AskBgp : ISparqlAlgebra
    {
