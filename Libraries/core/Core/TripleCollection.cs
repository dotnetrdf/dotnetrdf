...
namespace VDS.RDF
{
    ...
    /// </para>
    /// </remarks>
    [Obsolete("This implementation is considered obsolete and will be removed in future releases, it is superceded by the more performant TreeIndexedTripleCollection", true)]
